...
export const api = {
  ...
  stats: (params = {}) => http.get("/portfolio/stats", { params }).then((r) => r.data),
  equityHistory: (params = {}) => http.get("/portfolio/equity-history", { params }).then((r) => r.data),
  exportCsv: () => `${API}/portfolio/export-csv`,
